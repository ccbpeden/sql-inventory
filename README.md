# **SQL Inventory**
#### Charles Peden & Carlos Munoz Kampff, 2/24/2017
...
* Go to my [Github repository] (https://github.com/ccbpeden/sql-inventory)
* Download the zip file via the green button
* Unzip the file and open the **sql-inventory** folder
* Open Terminal, navigate to **sql-inventory** project folder, type **_composer install_** and hit enter
* Navigate Terminal to the **sql-inventory/web** folder and set up a server by typing **_php -S localhost:8000_**
...
Copyright (c) 2017 Charles Peden & Carlos Munoz Kampff
